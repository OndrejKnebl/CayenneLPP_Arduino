...
//
// Original from site: https://github.com/ElectronicCats/CayenneLPP/blob/master/src/CayenneLPP.cpp
// Added type smallTime for Multifunctional switching device (Multifunkční spínací zařízení), Ondřej Knebl, 22. 4. 2023
...
bool CayenneLPP::isType(uint8_t type) {
  ...
  switch (type) {
    ...
    case LPP_UNIXTIME:
#endif
#ifndef CAYENNE_DISABLE_SMALL_TIME
    case LPP_SMALLTIME:
#endif
...
#ifndef CAYENNE_DISABLE_SMALL_TIME
uint8_t CayenneLPP::addSmallTime(uint8_t channel, uint32_t value) {
  return addField(LPP_SMALLTIME, channel, value);
}
#endif
