...
// the LICENSE file.
//
// Original from site: https://github.com/ElectronicCats/CayenneLPP/blob/master/src/CayenneLPP.h
...
#define LPP_SMALLTIME 192           // 2 bytes, unsigned
...
public:
  ...
  uint8_t addSmallTime(uint8_t channel, uint32_t value);
#endif
